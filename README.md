...
There is also a generic _wrap-format-response_ on which the others depend. Each of these wrappers take 3 optional args: **:encoder**, **:predicate**, and **:charset**. See _wrap-format-response_ doc for further details.
